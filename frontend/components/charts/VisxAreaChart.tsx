  ...
  return (
    <div className="relative">
      <svg width={width} height={height}>
        <defs>
          <LinearGradient id="area-gradient" from={getSeriesColor(0)} to={getSeriesColor(0)} fromOpacity={0.4} toOpacity={0.05} />
          {isMultiSeries && seriesKeys?.map((_, i) => (
            <LinearGradient key={i} id={`area-gradient-${i}`} from={getSeriesColor(i)} to={getSeriesColor(i)} fromOpacity={0.4} toOpacity={0.05} />
          ))}
        </defs>
                  ...
                  return (
                    <circle
                      ...
                      onMouseMove={(event) => {
                        ...
                        showTooltip({ tooltipData: { ...d, seriesKey: sk, seriesValue: val }, tooltipTop: point.y, tooltipLeft: point.x })
                      }}
